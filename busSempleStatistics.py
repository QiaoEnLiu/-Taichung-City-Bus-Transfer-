    ...
    while search!='Quit':
        ...
        if search =='1':
            ...
            if sortStops=="1":
                ...
                stopNameList=[]
                for i in busList:
                    # if [i[Stop.stopName_CN],i[Stop.stopName_EN]] not in stopNameList:
                    #     stopNameList.append([i[Stop.stopName_CN],i[Stop.stopName_EN]])
                    Stop.unduplicateList(stopNameList, [i[Stop.stopName_CN],i[Stop.stopName_EN]])
                ...
                stopNameList=[]
                for i in busList:
                    tempLocat=[i[Stop.stopName_CN],i[Stop.stopName_EN],i[Stop.latitude],i[Stop.longitude]]
